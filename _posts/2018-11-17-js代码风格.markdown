...
#### 7.10.2 Type Casts[![img](https://google.github.io/styleguide/include/link.png)](https://google.github.io/styleguide/jsguide.html#jsdoc-type-casts)
...
#### 7.10.3 Template Parameter Types[![img](https://google.github.io/styleguide/include/link.png)](https://google.github.io/styleguide/jsguide.html#jsdoc-template-parameter-types)
...
#### 7.10.4 Function type expressions[![img](https://google.github.io/styleguide/include/link.png)](https://google.github.io/styleguide/jsguide.html#jsdoc-function-types)
...
Where the function definition is given, do not use a function type expression. Specify parameter and return types with `@param` and `@return`, or with inline annotations (see [7.8 Method and function comments](https://google.github.io/styleguide/jsguide.html#jsdoc-method-and-function-comments)). This includes anonymous functions and functions defined and assigned to a const (where the function jsdoc appears above the whole assignment expression).
...
#### 7.10.5 Whitespace[![img](https://google.github.io/styleguide/include/link.png)](https://google.github.io/styleguide/jsguide.html#jsdoc-whitespace)

Within a type annotation, a single space or line break is required after each comma or colon. Additional line breaks may be inserted to improve readability or avoid exceeding the column limit. These breaks should be chosen and indented following the applicable guidelines (e.g. [4.5 Line-wrapping](https://google.github.io/styleguide/jsguide.html#formatting-line-wrapping) and [4.2 Block indentation: +2 spaces](https://google.github.io/styleguide/jsguide.html#formatting-block-indentation)). No other whitespace is allowed in type annotations.
...
### 7.11 Visibility annotations[![img](https://google.github.io/styleguide/include/link.png)](https://google.github.io/styleguide/jsguide.html#jsdoc-visibility-annotations)
...
## 8 Policies[![img](https://google.github.io/styleguide/include/link.png)](https://google.github.io/styleguide/jsguide.html#policies)

### 8.1 Issues unspecified by Google Style: Be Consistent![![img](https://google.github.io/styleguide/include/link.png)](https://google.github.io/styleguide/jsguide.html#policies-be-consistent)
...
### 8.2 Compiler warnings[![img](https://google.github.io/styleguide/include/link.png)](https://google.github.io/styleguide/jsguide.html#policies-compiler-warnings)

#### 8.2.1 Use a standard warning set[![img](https://google.github.io/styleguide/include/link.png)](https://google.github.io/styleguide/jsguide.html#policies-use-a-standard-warning-set)

As far as possible projects should use `--warning_level=VERBOSE`.

#### 8.2.2 How to handle a warning[![img](https://google.github.io/styleguide/include/link.png)](https://google.github.io/styleguide/jsguide.html#policies-how-to-handle-a-warning)
...
#### 8.2.3 Suppress a warning at the narrowest reasonable scope[![img](https://google.github.io/styleguide/include/link.png)](https://google.github.io/styleguide/jsguide.html#policies-suppress-a-warning-at-the-narrowest-reasonable-scope)
...
### 8.3 Deprecation[![img](https://google.github.io/styleguide/include/link.png)](https://google.github.io/styleguide/jsguide.html#policies-deprecation)
...
### 8.4 Code not in Google Style[![img](https://google.github.io/styleguide/include/link.png)](https://google.github.io/styleguide/jsguide.html#policies-code-not-in-google-style)
...
#### 8.4.1 Reformatting existing code[![img](https://google.github.io/styleguide/include/link.png)](https://google.github.io/styleguide/jsguide.html#policies-reformatting-existing-code)
...
#### 8.4.2 Newly added code: use Google Style[![img](https://google.github.io/styleguide/include/link.png)](https://google.github.io/styleguide/jsguide.html#policies-newly-added-code-use-google-style)

Brand new files use Google Style, regardless of the style choices of other files in the same package.

When adding new code to a file that is not in Google Style, reformatting the existing code first is recommended, subject to the advice in [8.4.1 Reformatting existing code](https://google.github.io/styleguide/jsguide.html#policies-reformatting-existing-code).
...
### 8.5 Local style rules[![img](https://google.github.io/styleguide/include/link.png)](https://google.github.io/styleguide/jsguide.html#policies-local-style-rules)
...
### 8.6 Generated code: mostly exempt[![img](https://google.github.io/styleguide/include/link.png)](https://google.github.io/styleguide/jsguide.html#policies-generated-code-mostly-exempt)
...
## 9 Appendices[![img](https://google.github.io/styleguide/include/link.png)](https://google.github.io/styleguide/jsguide.html#appendices)

### 9.1 JSDoc tag reference[![img](https://google.github.io/styleguide/include/link.png)](https://google.github.io/styleguide/jsguide.html#appendices-jsdoc-tag-reference)
...
#### 9.1.1 Type annotations and other Closure Compiler annotations[![img](https://google.github.io/styleguide/include/link.png)](https://google.github.io/styleguide/jsguide.html#appendices-type-annotations)
...
#### 9.1.2 Documentation annotations[![img](https://google.github.io/styleguide/include/link.png)](https://google.github.io/styleguide/jsguide.html#appendices-documentation-annotations)
...
#### 9.1.3 Framework specific annotations[![img](https://google.github.io/styleguide/include/link.png)](https://google.github.io/styleguide/jsguide.html#appendices-framework-specific-annotations)
...
#### 9.1.4 Notes about standard Closure Compiler annotations[![img](https://google.github.io/styleguide/include/link.png)](https://google.github.io/styleguide/jsguide.html#appendices-notes-about-standard-closure-compiler-annotations)
...
### 9.2 Commonly misunderstood style rules[![img](https://google.github.io/styleguide/include/link.png)](https://google.github.io/styleguide/jsguide.html#appendices-commonly-misunderstood-style-rules)
...
### 9.3 Style-related tools[![img](https://google.github.io/styleguide/include/link.png)](https://google.github.io/styleguide/jsguide.html#appendices-style-related-tools)

The following tools exist to support various aspects of Google Style.

#### 9.3.1 Closure Compiler[![img](https://google.github.io/styleguide/include/link.png)](https://google.github.io/styleguide/jsguide.html#appendices-tools-closure-compiler)
...
#### 9.3.2 `clang-format`[![img](https://google.github.io/styleguide/include/link.png)](https://google.github.io/styleguide/jsguide.html#appendices-clang-format)
...
#### 9.3.3 Closure compiler linter[![img](https://google.github.io/styleguide/include/link.png)](https://google.github.io/styleguide/jsguide.html#appendices-closure-compiler-linter)

This program checks for a variety of missteps and anti-patterns.

#### 9.3.4 Conformance framework[![img](https://google.github.io/styleguide/include/link.png)](https://google.github.io/styleguide/jsguide.html#appendices-conformance-framework)
...
### 9.4 Exceptions for legacy platforms[![img](https://google.github.io/styleguide/include/link.png)](https://google.github.io/styleguide/jsguide.html#appendices-legacy-exceptions)

#### 9.4.1 Overview[![img](https://google.github.io/styleguide/include/link.png)](https://google.github.io/styleguide/jsguide.html#appendices-legacy-exceptions-overview)
...
#### 9.4.2 Use `var`[![img](https://google.github.io/styleguide/include/link.png)](https://google.github.io/styleguide/jsguide.html#appendices-legacy-exceptions-var)
...
#### 9.4.3 Do not use block scoped functions declarations[![img](https://google.github.io/styleguide/include/link.png)](https://google.github.io/styleguide/jsguide.html#appendices-legacy-exceptions-function)
...
#### 9.4.4 Dependency management with `goog.provide`/`goog.require`[![img](https://google.github.io/styleguide/include/link.png)](https://google.github.io/styleguide/jsguide.html#appendices-legacy-exceptions-goog-provide)
